...
BASE_URL_LSP = "https://zim.prf001.aorta-zorg.nl"
...
def introspect_access_token(request_handler):
	"""Introspect Nuts access token"""
	bearer = request_handler.headers['Authorization'] # Bearer YourTokenHere
	if bearer is None:
		responseCode = 403
	...
	tokenvalidationresult = call_node_introspect(token)
